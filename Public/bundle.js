...
var _DashboardContainer = __webpack_require__(100);
...
var store = (0, _redux.createStore)(_root.combinedReducer);
...
var Root = function Root(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      null,
      React.createElement(_reactRouterDom.Route, { path: '/', component: _DashboardContainer2.default })
    )
  );
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(37), __webpack_require__(87)(module)))
...
var _currentEvent = __webpack_require__(97);

var _hostingEvents = __webpack_require__(98);

var _currentUser = __webpack_require__(99);
...
var combinedReducer = (0, _redux.combineReducers)(_currentEvent.currentEvent, _hostingEvents.hostingEvents, _currentUser.currentUser);
...
function currentEvent() {
    ...
    switch (action.type) {
        ...
        case 'ADD_ITEM':
            return Object.assign({}, state, {
                currentEventRegistry: [].concat(_toConsumableArray(state.currentEventRegistery), [action.item])
            });
        case 'REMOVE_ITEM':
            return Object.assign({}, state, {
                currentEventRegistry: [].concat(_toConsumableArray(state.currentEventRegistry)).splice(action.index, 1)
            });
        case 'ASSIGN_ITEM':
            var copyOfEventRegistery = [].concat(_toConsumableArray(state.currentEventRegistery));
        ...
        case 'ADD_GUEST':
            return Object.assign({}, state, {
                invitedGuests: [].concat(_toConsumableArray(state.invitedGuests), [action.guest])
            });
        case 'TOGGLE_GUEST_ATTENDANCE':
            var copy = [].concat(_toConsumableArray(state.attending));
...
var hostingEvents = function hostingEvents() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];

    switch (action.type) {
        case 'CREATE_EVENT':
            return [].concat(_toConsumableArray(state), [action.newEvent]);
        case 'DELETE_EVENT':
...
var _currentEventActions = __webpack_require__(101);

var _currentEventActions2 = _interopRequireDefault(_currentEventActions);

var _eventList = __webpack_require__(102);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        onEventClick: function onEventClick(event) {
            dispatch((0, _currentEventActions2.default)(event));
        }
    };
};
    ...
    _createClass(DashboardContainer, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                null,
                React.createElement(_eventList2.default, {
...
var setCurrentEvent = exports.setCurrentEvent = function setCurrentEvent(event) {
    return {
...
var updateDescription = exports.updateDescription = function updateDescription(description) {
    return {
...
var updateDate = exports.updateDate = function updateDate(date) {
    return {
        type: 'UPDATE_DATE',
        date: date
    };
...
var removeItem = exports.removeItem = function removeItem(index) {
    return {
        type: 'REMOVE_ITEM',
        index: index
    };
...
var assignItem = exports.assignItem = function assignItem(userId) {
    return {
        type: 'ASSIGN_ITEM',
        userId: userId
    };
...
var addGuest = exports.addGuest = function addGuest(guest) {
    return {
        type: 'ADD_GUEST',
        guest: guest
    };
...
var removeGuest = exports.removeGuest = function removeGuest(index) {
    return {
        type: 'REMOVE_GUEST',
        index: index
    };
...
var Event = function Event(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement("img", { src: event.image })
    );
};
