        ...
        <div>
          ...
          <div>
            <Switch>
              ...
              <Route path="/eventPage/:id" render={({match}) => <EventPage currentUser={this.state.currentUser}
                currentGuest={match}
                // clickAttending={this.clickAttending.bind(this)}
                // clickNotAttending={this.clickNotAttending.bind(this)}
              />}/>
